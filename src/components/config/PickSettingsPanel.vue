    ...
    <div class="ba-card">
      ...
      <div class="ba-toggle-row">
        ...
        <div class="ba-toggle-content">
          ...
          <span class="ba-toggle-hint">如果老师在上课时用，记得确认一下环境哦～不要社死了！每次会随机播放超喜庆的BGM～</span>
        </div>
      </div>
      ...
      <div class="ba-toggle-row">
        ...
        <div class="ba-toggle-content">
          <span class="ba-toggle-label">点名时播放音效～</span>
          <span class="ba-toggle-hint">和BGM一样，上课注意音量哦♪</span>
        </div>
      </div>
