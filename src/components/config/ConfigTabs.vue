<template>
  <nav class="ba-sidebar-nav">
    <div v-for="group in tabGroups" :key="group.title" class="ba-nav-group">
...
<style scoped>
  ...
  .ba-nav-item.active {
    background: linear-gradient(135deg, rgba(18, 138, 250, 0.1) 0%, rgba(18, 138, 250, 0.05) 100%);
    color: #128afa;
  }
