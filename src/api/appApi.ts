...
export const appApi = {
  ...
  parseStudentListText: (rawText: string, existingStudents: any[]) => invoke<any>('parse_student_list_text', { rawText, existingStudents }),
  importStudentListFromFile: (existingStudents: any[]) => invoke<any>('import_student_list_from_file', { existingStudents }),
  ...
  createAdminStartupTask: (exePath: string, taskName: string) => invoke<any>('create_admin_startup_task', { exePath, taskName }),
